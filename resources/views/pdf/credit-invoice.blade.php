...
<head>
    ...
    <style>
        ...
        .total-row td { border-top: 2px solid #0f766e; font-size: 13px; }
...
<body>
    <div class="header">
        ...
        <p class="meta">Invoice #{{ $invoiceNo }} · {{ $currencyCode }}</p>
    </div>
    ...
    <table class="lines">
        ...
        <tr>
            <td>
                Credit extended (tabar / stock on credit)
                @if($itemLabel)
                    <br><span style="color:#64748b;font-size:10px;">Item: {{ $itemLabel }}</span>
                @endif
                @if($note)
        ...
        <tr class="total-row">
            <td><strong>Total due (customer balance after this credit)</strong></td>
